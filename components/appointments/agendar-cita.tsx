...
const PLACEHOLDER_MAP = {
  label: "Yantissimo",
  src: "https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d60264.83893809881!2d-103.75312005290255!3d19.258328026390565!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1sYantissimo!5e0!3m2!1ses-419!2smx!4v1770965158541!5m2!1ses-419!2smx",
};
        ...
        {currentStep === 2 ? (
          <section className="rounded-2xl md:border md:border-neutral-800/80 md:bg-neutral-900/70 p-0 md:p-5">
            ...
            <div className="space-y-3">
              ...
              <div className="mt-4 h-95 md:h-95 overflow-hidden rounded-xl border border-neutral-800/80 bg-neutral-950/60">
